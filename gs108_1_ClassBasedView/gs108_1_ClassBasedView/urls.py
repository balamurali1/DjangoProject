"""gs108_1_ClassBasedView URL Configuration
...
urlpatterns = [
    ...
    #path('newscl/',views.NewClassView.as_view(),name = 'newscl'),
    #path('newscl/',views.NewClassView.as_view(),name = 'newscl'),
    #path('newscl/',views.NewClassView.as_view(),name = 'newscl'),

    #path('newscl/',views.NewClassView.as_view(template_name = 'school/news.html'),name = 'newscl'),
    path('newscl2/',views.NewClassView.as_view(template_name = 'school/news2.html'),name = 'newscl2'),
